...
const Footer: React.FC = () => (
  <div className="flex w-full max-w-[800px] flex-col items-center justify-center bg-neutral-50 p-4 py-[40px] text-center md:max-w-full xs:max-w-[600px]">
    ...
    <div className="flex flex-col justify-center space-y-4 sm:flex-row sm:space-x-8 sm:space-y-0">
      <div className="text-center">
        <div className="font-bold text-sky-800">
          <IoBusinessOutline className="mr-2 inline-block" />
          사업개발
        </div>
        <p className="text-sky-800">오수경, 김명석, 전두열</p>
      </div>
      <div className="text-center">
        <div className="font-bold text-sky-800">
        ...
        <p className="text-sky-800">장진영, 김보람, 김준현</p>
      </div>
      <div className="text-center">
        <div className="font-bold text-sky-800">
        ...
        <p className="text-sky-800">노성우, 신현민</p>
      </div>
    </div>
  </div>
);
