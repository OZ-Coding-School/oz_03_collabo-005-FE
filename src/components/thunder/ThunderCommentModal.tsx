...
interface ThunderCommentModalProps {
  isOpen: boolean;
  onClose: () => void;
  title1: string;
  title2: string;
...
// ThunderCommentModal 를 위한 컴포넌트.

const ThunderCommentModal: React.FC<ThunderCommentModalProps> = ({ isOpen, title1, title2, children, onClose }) => {
...
export default ThunderCommentModal;
